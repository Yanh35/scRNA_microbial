...
#n = str_which(mpa$V1, 'k__Eukaryota')
taxid = kr$V7[n]
...
str = paste0("gawk 'NR==FNR{ a[$1]; next }FNR in a' ", opt$out_path, opt$sample_name, '_line_numbers.txt ', opt$fq, " > ", opt$out_path, opt$sample_name, ".fa")
system(str)
